...
class Test(unittest.TestCase):
  ...
  def test_find_max_profit(self):
    ...
    self.assertEqual(find_max_profit([100, 90, 80, 50, 20, 10]), -10) # I just want to say that it is very silly that you HAVE to buy and sell. There is no option to not buy
